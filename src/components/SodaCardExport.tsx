        ...
        <div className="flex-1 h-full p-12 flex flex-col justify-between relative z-10">
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-3xl bg-gradient-to-br from-accent/20 to-accent-purple/20 border border-white/5">
                {can.icon}
              </div>
              <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 relative">
                  <p className="text-sm text-muted leading-relaxed font-mono italic">
                    "{prompt}"
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-8">
                <div>
                  <div className="font-mono text-[9px] tracking-[0.2em] text-muted-dark uppercase mb-1">Category</div>
                  <div className="text-white font-medium capitalize">{can.category}</div>
                </div>
                <div>
                  <div className="font-mono text-[9px] tracking-[0.2em] text-muted-dark uppercase mb-1">Edition</div>
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="text-right">
              <div className="font-mono text-[10px] text-muted-dark uppercase tracking-widest">Generated by</div>
